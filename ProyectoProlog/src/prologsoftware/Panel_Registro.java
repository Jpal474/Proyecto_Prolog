...
public class Panel_Registro extends javax.swing.JFrame {
    ...
    private void RegistroButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistroButtonActionPerformed
        ...
        if (!NameText.getText().equals("") && !CaracteristicasText.getText().equals("") && !ValoresText.getText().equals("")) {
            try {
                escribir = new FileWriter(archivo, true);
                linea = new PrintWriter(escribir);

                linea.print("\n\npersonas(" + NameText.getText() + ").");
                linea.print("\ncPersona(" + NameText.getText() + ",[" + CaracteristicasText.getText() + "]).");
                linea.print("\ngPersona(" + NameText.getText() + ",[" + ValoresText.getText() + "])." );
